...
El proceso comienza en el Estado Bolívar con la extracción de la materia prima nacional: Bloques de granito. Continúa con su procesamiento en las instalaciones en el estado Miranda -en el eje Guarenas-Guatire- y es ofrecida directamente a través de nuestra red de distribución en los estados Anzoátegui, Bolívar, Carabobo, Falcón, Lara, Miranda y Monagas..
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 mb-sm-30">
                                    <img src="img/la-leona.jpg" alt="" />
                                </div>
                                
                                <div class="col-md-5 col-md-offset-1">
                                    <h4 class="content-title">LA LEONA</h4>
                                    <p>Explotación de Canteras con calidad certificada.</p>
                                    <ul class="list-inside">
                                        <li>Guayana Edo. Bolívar</li>
    ...
    <div class="item">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 mb-sm-30">
                                    <img src="img/lizardero2.jpg" alt="" />
                                </div>
                                <div class="col-md-5 col-md-offset-1">
                                    <h4 class="content-title">LIZARDERO II</h4>
                                    <p>Explotación de Canteras con calidad certificada.</p>
                    ...
                    <div class="item">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 mb-sm-30">
                                    <img src="img/lizardero3.jpg" alt="" />
                                </div>
                                <div class="col-md-5 col-md-offset-1">
                                    <h4 class="content-title">LIZARDERO III</h4>
                                    <p>Explotación de Canteras con calidad certificada.</p>
  ...
  <?php 
                                    ...
                                    <div class="col-md-4">
                                        <div class="cover-box mb-30">
                                            ...
                                            <div class="cover-box-content">
                                                ...
                                                <a  href="blog.php?id=<?php echo $news['news'][$i]['id']  ?>" class="link">Leer Mas <i class="fa fa-angle-right right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <center><a href="blog.php" target="_black" class="btn-contact-submit btn btn-md btn-color" type="button" name="">Ver Blog</a></center>
            </section>
